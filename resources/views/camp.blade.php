        ...
        <div class="container">
            ...
            <section class="hero pb-5">
                <div class="hero__image text-center">
                    <img class="img-fluid rounded" width="330" src="/storage/profile/{{$user->photoUrl}}" alt="social">
                </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            <div class="album mediaClick" data-toggle="modal" data-target="#albumModel">
                                <div class="card border-0 shadow overflow-hidden">
                                    <img src="/storage/cover/{{$value['cover']}}" alt="Album Image">
                                </div>
                                <div class="card-caption">
                                    <h5 class="mt-4">{{$value['title']}}</h5>
                                    <p class="mt-2 mb-4">{{$value['description']}}</p>
                                    ...
                                    <div class="col-md-6 description ">
                                        ...
                                        <div class="tab-content rounded">
                                            ...
                                            <div class="tab-pane fade rounded" id="description-edit" role="tabpanel"
                                                ...
                                                <form method="post" action="{{ action('MediaController@updateMedia') }}">
                                                {{csrf_field()}}
