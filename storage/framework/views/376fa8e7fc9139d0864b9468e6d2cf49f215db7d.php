                ...
                <?php echo $__env->make('inc.messages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="tab-content">
                        <div id="individualForm" class="tab-pane active">
                            <form method="post" class="text-center row needs-validation" action="<?php echo e(action('FirebaseAuthController@store')); ?>" novalidate>
...
</html><?php /**PATH E:\clients\Charmello\charmello\resources\views/auth/register.blade.php ENDPATH**/ ?>