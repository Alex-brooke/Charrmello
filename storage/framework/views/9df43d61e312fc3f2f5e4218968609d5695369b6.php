    ...
    <main>
        <div class="container position-relative">
            ...
            <div class="p-section">
                ...
                <form id="mediaUploadForm" method="POST" action="<?php echo e(action('MediaController@store')); ?>" enctype="multipart/form-data">
...
</html><?php /**PATH E:\clients\Charmello\charmello\resources\views/camp/create.blade.php ENDPATH**/ ?>